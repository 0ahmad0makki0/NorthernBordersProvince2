<%@ Page Title="" Language="C#" MasterPageFile="~/ProvisionsMonitoring/ProvisionsMonitoring.Master" AutoEventWireup="true" CodeBehind="ProvisionsMonitoringUsersSettingsForm.aspx.cs" Inherits="NorthernBordersProvince.ProvisionsMonitoringUsersSettingsForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function OnCheckBoxChanged(ckb) {
            ...
            var inputList = row.getElementsByTagName("input");
            if (ckb.id == inputList[2].id && inputList[2].id.indexOf('ckbView') >= 0) {
                ...
                if (ckb.checked == true && inputList[2].id.indexOf('ckbView') >= 0) {
                    ...
                    <tr class="FormRow">
                        ...
                        <td class="FormFieldDataCell">
                            ...
                            <asp:GridView ID="gvPermissions" CssClass="GridViewTabular" runat="server" AutoGenerateColumns="False" 
                                ...
                                DataKeyNames="ProvisionsMonitoringPage_Id">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                                    <asp:Label ID="lblPage" runat="server" Text='<%# Eval("ProvisionsMonitoringPageTitle")%>' />
                                                    <asp:HiddenField ID="hfPageId" runat="server" Value='<%# Eval("ProvisionsMonitoringUser_Id") %>'/>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                                    <asp:CheckBox ID="ckbView" runat="server" Text="عرض" Checked='<%# Eval("CanView") %>' Visible='<%# Eval("ViewEnabled") %>' onclick="OnCheckBoxChanged(this);"/>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                                    <asp:CheckBox ID="ckbAdd" runat="server" Text="إضافة" Checked='<%# Eval("CanAdd") %>' Visible='<%# Eval("AddEnabled") %>' onclick="OnCheckBoxChanged(this);"/>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                                    <asp:CheckBox ID="ckbEdit" runat="server" Text="تعديل" Checked='<%# Eval("CanEdit") %>' Visible='<%# Eval("EditEnabled") %>' onclick="OnCheckBoxChanged(this);"/>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                                    <asp:CheckBox ID="ckbDelete" runat="server" Text="حذف" Checked='<%# Eval("CanDelete") %>' Visible='<%# Eval("DeleteEnabled") %>' onclick="OnCheckBoxChanged(this);"/>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    </asp:TemplateField>
                                </Columns>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="sp_GetProvisionsMonitoringUserPermissions" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:QueryStringParameter Name="ProvisionsMonitoringUser_Id" ConvertEmptyStringToNull="true" QueryStringField="ID" Type="Int64" DefaultValue="0" />
                                    </SelectParameters>
                            </asp:SqlDataSource>
                            </div>
                        </td>
