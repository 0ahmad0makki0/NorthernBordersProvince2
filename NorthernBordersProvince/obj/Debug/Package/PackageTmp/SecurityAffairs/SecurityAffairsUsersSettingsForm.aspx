<%@ Page Title="" Language="C#" MasterPageFile="~/SecurityAffairs/SecurityAffairs.Master" AutoEventWireup="true" CodeBehind="SecurityAffairsUsersSettingsForm.aspx.cs" Inherits="NorthernBordersProvince.SecurityAffairsUsersSettingsForm" %>
                    ...
                    <tr class="FormRow">
                        ...
                        <td class="FormFieldDataCell">
                            ...
                            <asp:GridView ID="gvPermissions" CssClass="GridViewTabular" runat="server" AutoGenerateColumns="False" 
                                ...
                                DataKeyNames="SecurityAffairsPage_Id">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                                    <asp:Label ID="lblPage" runat="server" Text='<%# Eval("SecurityAffairsPageTitle")%>' />
                                                    <asp:HiddenField ID="hfPageId" runat="server" Value='<%# Eval("SecurityAffairsUser_Id") %>'/>
                                        </ItemTemplate>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="sp_GetSecurityAffairsUserPermissions" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:QueryStringParameter Name="SecurityAffairsUser_Id" ConvertEmptyStringToNull="true" QueryStringField="ID" Type="Int64" DefaultValue="0" />
                                    </SelectParameters>
                            </asp:SqlDataSource>
                            </div>
                        </td>
