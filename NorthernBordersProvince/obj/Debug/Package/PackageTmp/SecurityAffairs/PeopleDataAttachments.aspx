<%@ Page Title="" Language="C#" MasterPageFile="~/SecurityAffairs/SecurityAffairs.Master" AutoEventWireup="true" CodeBehind="PeopleDataAttachments.aspx.cs" Inherits="NorthernBordersProvince.PeopleDataAttachments" %>
    ...
    <div class="PageContainer">
            ...
            <table width="100%">
                <tr style="vertical-align: middle;">
                    <td>
                        ...
                        <a href="../Files/UserGuide/SecurityAffairs/PeopleDataAttachments.pdf" style="border:none;" target="_blank"><img class="HeadManibulationButton" src="../Images/Help.png" alt="دليل الإستخدام"/></a>
                   </td>
        ...
        <div class="PageContents">
            ...
            <asp:GridView ID="gvContents" CssClass="GridViewTabular" runat="server" AutoGenerateColumns="False" 
                ...
                DataKeyNames="PeopleDataAttachment_Id"
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="sp_GetPeopleDataAttachments" 
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:QueryStringParameter Name="PeopleData_Id" QueryStringField="ID" 
                        Type="Int64" />
                </SelectParameters>
            </asp:SqlDataSource>
