<%@ Page Title="" Language="C#" MasterPageFile="~/SecurityAffairs/SecurityAffairs.Master" AutoEventWireup="true" CodeBehind="UsersLogsReport.aspx.cs" Inherits="NorthernBordersProvince.UsersLogsReport" %>
                    ...
                    <tr class="FormRow">
                        ...
                        <td class="FormFieldDataCell" style="border:none; background: none;">
                            <asp:DropDownList ID="ddlUser" runat="server" 
                                ...
                                DataTextField="Title" DataValueField="SecurityAffairsUser_Id">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:NorthernBordersProvinceDBConnectionString %>" 
                                SelectCommand="sp_GetSecurityAffairsUsersForFilter" 
                    ...
                    <tr class="FormRow">
                        ...
                        <td class="FormFieldDataCell" style="border:none; background: none;">
                            <asp:DropDownList ID="ddlPage" runat="server" 
                                ...
                                DataTextField="Title" DataValueField="SecurityAffairsPage_Id" 
                                AutoPostBack="True">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:NorthernBordersProvinceDBConnectionString %>" 
                                SelectCommand="sp_GetSecurityAffairsPagesForFilter" 
                                SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                        </td>
                    </tr>
                    <tr class="FormRow">
                        ...
                        <td class="FormFieldDataCell" style="border:none; background: none;">
                            <asp:DropDownList ID="ddlRole" runat="server" 
                                ...
                                DataTextField="Title" DataValueField="SecurityAffairsRole_Id">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:NorthernBordersProvinceDBConnectionString %>" 
                                SelectCommand="sp_GetSecurityAffairsRolesForFilter" 
