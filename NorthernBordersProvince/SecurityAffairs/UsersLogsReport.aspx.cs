...
{
    public partial class UsersLogsReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!FL.IsSecurityAffairsUserAuthorized(5, 1)) { FL.ConfirmationMessage("لا توجد لديك صلاحية لعرض  سجلات (عمليات) المستخدمين", this, "ReportsMain.aspx"); return; }
            if (!IsPostBack)
            {
        ...
        private void LoadData()
        {
            ...
            List<sp_GetSecurityAffairsUsersLogsReport_Result> logsReport = ctx.GetSecurityAffairsUsersLogsReport(
        ...
        {
            FL.AddSecurityAffairsUserLog(5, 1, "");
        }
