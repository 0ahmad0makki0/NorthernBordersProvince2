<%@ Page Title="" Language="C#" MasterPageFile="~/SecurityAffairs/SecurityAffairs.Master" AutoEventWireup="true" CodeBehind="SecurityAffairsUsersSettingsMain.aspx.cs" Inherits="NorthernBordersProvince.SecurityAffairsUsersSettingsMain" %>
    ...
    <div class="PageContainer">
            ...
            <table width="100%">
                <tr style="vertical-align: middle;">
                    <td>
                        ...
                        <a href="../Files/UserGuide/SecurityAffairs/UsersSettings.pdf" style="border:none;" target="_blank"><img class="HeadManibulationButton" src="../Images/Help.png" alt="دليل الإستخدام"/></a>
                    </td>
                    <td style="text-align:left;">
                        <a href="SecurityAffairsUsersSettingsForm.aspx?Mode=Add" style="border:none;"><img class="HeadManibulationButton" src="../Images/GridViewImages/Add.png" alt="إضافة"/></a>
                    </td>
                </tr>
            </table>
        </div>
        <div class="PageContents">
            <asp:GridView ID="gvContents" CssClass="GridViewTabular" runat="server" AutoGenerateColumns="False" 
                ...
                DataKeyNames="SecurityAffairsUser_Id"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                                <div>
                                    <a href="SecurityAffairsUsersSettingsForm.aspx?Mode=Show&ID=<%# Eval("SecurityAffairsUser_Id") %>" style="border:none;"><img class="ManibulationButton" src="../Images/GridViewImages/Show.png" alt="عرض"></a>
                                </div>
                        </ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="sp_GetSecurityAffairsUsers" SelectCommandType="StoredProcedure">
                <SelectParameters>
