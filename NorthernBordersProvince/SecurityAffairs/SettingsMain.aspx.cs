    ...
    public partial class SettingsMain : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!FL.IsSecurityAffairsUserAuthorized(6, 1) &&
                ...
                !FL.IsSecurityAffairsUserAuthorized(6, 4) &&
                !FL.IsSecurityAffairsUserAuthorized(7, 1) &&
                !FL.IsSecurityAffairsUserAuthorized(7, 2) &&
                !FL.IsSecurityAffairsUserAuthorized(7, 3) &&
                !FL.IsSecurityAffairsUserAuthorized(7, 4)) { FL.ConfirmationMessage("لا توجد لديك صلاحية للدخول على الإعدادات", this, "default.aspx"); return; }
        ...
        private void LoadData()
        {
            ...
            titles.Add("المؤهلات الدراسية");
            titles.Add("مستخدمين النظام");
            List<string> Links = new List<string>();
            Links.Add("EducationLevelSettingsMain.aspx");
            Links.Add("SecurityAffairsUsersSettingsMain.aspx");
            string s = "";
