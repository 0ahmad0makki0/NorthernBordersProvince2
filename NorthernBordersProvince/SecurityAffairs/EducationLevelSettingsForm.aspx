<%@ Page Title="" Language="C#" MasterPageFile="~/SecurityAffairs/SecurityAffairs.Master" AutoEventWireup="true" CodeBehind="EducationLevelSettingsForm.aspx.cs" Inherits="NorthernBordersProvince.EducationLevelSettingsForm" %>
        ...
        <div class="PageContents">
            <div class="FormContents">
                <table style="width:100%;">
                    <tr class="FormRow">
                        <td class="FormFieldTitleCell FirstRow">إسم المؤهل الدراسي <label class="ValidationLabel">*</label></td>
                        <td class="FormFieldDataCell FirstRow">
                            <asp:TextBox ID="txtTitle" runat="server" placeholder="قم بإدخال إسم المؤهل الدراسي هنا" onchange="OnTextChanged(this)" CssClass="FormLongTextBoxes" />
                        </td>
                    </tr>
                </table>
            </div>
